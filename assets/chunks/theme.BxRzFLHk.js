...
这里会持续更新，欢迎常来。
`;function zo(e){const t=e&&e.match(/^---\r?\n([\s\S]*?)\r?\n---/);if(!t)return{};const n={},s=t[1].split(/\r?\n/);let a=0;for(;a<s.length;){const r=s[a].match(/^([A-Za-z\u4e00-\u9fa5_-]+):\s*(.*)$/);if(!r){a++;continue}const i=r[1],v=r[2].trim();if(v===""){const p=[];let L=a+1;for(;L<s.length&&/^\s*-\s+/.test(s[L]);)p.push(s[L].replace(/^\s*-\s+/,"").trim()),L++;n[i]=p.length?p:"",a=L;continue}const l=v.match(/^\[(.*)\]$/);l?n[i]=l[1].split(",").map(p=>p.trim()).filter(Boolean):n[i]=v.replace(/^["']|["']$/g,""),a++}return n}function Pe(){return Object.entries(Object.assign({"../../../posts/diary-20260819.md":xo,"../../../posts/diary-20260820.md":No,"../../../posts/diary-20260821.md":Ho,"../../../posts/diary-20260822.md":Co,"../../../posts/diary-20260823.md":Bo,"../../../posts/diary-20260824.md":Eo,"../../../posts/diary-20260825.md":Do,"../../../posts/diary-20260826.md":Fo,"../../../posts/diary-20260827.md":Oo,"../../../posts/diary-20260828.md":Go,"../../../posts/diary-20260829.md":jo,"../../../posts/how-i-built-this-blog.md":Uo})).map(([t,n])=>{const s=zo(n),a=t.split("/").pop().replace(/\.md$/,""),r=n.replace(/^---\r?\n[\s\S]*?\r?\n---\r?\n?/,"");return{title:s.title||a,date:s.date||"",tags:Array.isArray(s.tags)?s.tags:[],description:s.description||"",url:"/blog/posts/"+a,wordCount:r.replace(/\s/g,"").length}}).sort((t,n)=>t.date<n.date?1:-1)}const qo={key:0,class:"post-list"},Wo={key:0,class:"post-empty"},Ro=["href"],Ko={class:"post-meta"},Jo={key:0,class:"post-date"},Yo={class:"post-title"},Zo={key:0,class:"post-desc"},Qo=["href"],Xo={key:1,class:"diary-archive"},ei={key:0,class:"diary-stats"},ti={class:"diary-stat-icon"},ni={class:"diary-stat-body"},si={class:"diary-stat-num"},ai={class:"diary-stat-label"},oi={key:1,class:"post-empty"},ii={class:"diary-month-head"},li={class:"diary-month-title"},ri={class:"diary-year-line"},ci={key:0,class:"diary-year"},ui={class:"diary-month-label"},di={class:"diary-month-count"},vi={class:"diary-month-list"},fi={class:"diary-day-badge"},hi={class:"diary-entry-main"},mi=["href"],pi={key:0,class:"diary-desc"},_i={__name:"PostList",props:{tag:{type:String,default:""},excludeTag:{type:String,default:""},limit:{type:Number,default:0},mode:{type:String,default:"list"}},setup(e){const t=e,n=Pe(),s=y(()=>{let i=n.filter(v=>(!t.tag||v.tags.includes(t.tag))&&(!t.excludeTag||!v.tags.includes(t.excludeTag)));return t.limit&&(i=i.slice(0,t.limit)),i}),a=y(()=>{const i={};for(const v of s.value){const l=(v.date||"").slice(0,7)||"未标注日期";i[l]||(i[l]=[]),i[l].push(v)}return Object.keys(i).sort((v,l)=>v<l?1:-1).map(v=>{const[l,p]=v.split("-");return{ym:v,year:v==="未标注日期"?"":l,month:v==="未标注日期"?"?":Number(p),posts:i[v]}})}),r=y(()=>{const i=s.value.length,v=a.value.length,l=s.value.reduce((p,L)=>p+(L.wordCount||0),0);return[{icon:"📔",num:i,label:"篇日记"},{icon:"🗓️",num:v,label:"个月份"},{icon:"✍️",num:l.toLocaleString(),label:"字记录"}]});return(i,v)=>e.mode!=="archive"?(o(),c("div",qo,[s.value.length?m("",!0):(o(),c("p",Wo,"这里还没有内容，敬请期待～")),(o(!0),c(T,null,w(s.value,l=>(o(),c("article",{key:l.url,class:"post-card"},[d("a",{href:l.url,class:"post-card-main"},[d("div",Ko,[l.date?(o(),c("span",Jo,[v[0]||(v[0]=d("span",{class:"post-date-icon"},"📅",-1)),H(k(l.date),1)])):m("",!0),(o(!0),c(T,null,w(l.tags,p=>(o(),c("span",{key:p,class:"post-tag"},"#"+k(p),1))),128))]),d("h3",Yo,k(l.title),1),l.description?(o(),c("p",Zo,k(l.description),1)):m("",!0)],8,Ro),d("a",{href:l.url,class:"post-arrow","aria-label":"阅读文章"},"→",8,Qo)]))),128))])):(o(),c("div",Xo,[r.value[0].num?(o(),c("div",ei,[(o(!0),c(T,null,w(r.value,l=>(o(),c("div",{key:l.label,class:"diary-stat"},[d("span",ti,k(l.icon),1),d("div",ni,[d("span",si,k(l.num),1),d("span",ai,k(l.label),1)])]))),128))])):m("",!0),a.value.length?m("",!0):(o(),c("p",oi,"日记还是空白的，去写第一篇吧～")),(o(!0),c(T,null,w(a.value,l=>(o(),c("section",{key:l.ym,class:"diary-month-card"},[d("div",ii,[d("div",li,[v[1]||(v[1]=d("span",{class:"diary-month-emoji"},"📅",-1)),d("div",null,[d("div",ri,[l.year?(o(),c("span",ci,k(l.year)+" 年",1)):m("",!0)]),d("h2",ui,k(l.month)+" 月",1)])]),d("span",di,k(l.posts.length)+" 篇",1)]),d("ul",vi,[(o(!0),c(T,null,w(l.posts,p=>(o(),c("li",{key:p.url,class:"diary-entry"},[d("span",fi,k((p.date||"").slice(8,10)||"--"),1),d("div",hi,[d("a",{href:p.url,class:"diary-title"},k(p.title),9,mi),p.description?(o(),c("span",pi,k(p.description),1)):m("",!0)]),v[2]||(v[2]=d("span",{class:"diary-arrow"},"→",-1))]))),128))])]))),128))]))}},gi={class:"tag-page"},bi={key:0,class:"tag-cloud"},ki=["onClick","title"],$i={key:1,class:"post-empty"},yi={key:2,class:"tag-result-title"},Pi={class:"count"},Li={class:"count"},Vi={class:"post-list"},Si={key:0,class:"post-empty"},Ti=["href"],Ii={class:"post-meta"},Ai={key:0,class:"post-date"},Mi={class:"post-title"},wi={key:0,class:"post-desc"},xi=["href"],Ni={__name:"TagList",setup(e){const t=Pe(),n=I(""),s=y(()=>{const i={};for(const v of t)for(const l of v.tags)i[l]||(i[l]=[]),i[l].push(v);return Object.entries(i).map(([v,l])=>({name:v,count:l.length,posts:l.sort((p,L)=>p.date<L.date?1:-1)})).sort((v,l)=>l.count-v.count)}),a=y(()=>n.value?t.filter(i=>i.tags.includes(n.value)):t);function r(i){return i>=3?"cloud-lg":i===2?"cloud-md":"cloud-sm"}return(i,v)=>(o(),c("div",gi,[s.value.length?(o(),c("div",bi,[d("a",{class:A(["cloud-chip",["cloud-lg",{active:n.value===""}]]),onClick:v[0]||(v[0]=le(l=>n.value="",["prevent"]))},"全部",2),(o(!0),c(T,null,w(s.value,l=>(o(),c("a",{key:l.name,class:A(["cloud-chip",[r(l.count),{active:n.value===l.name}]]),onClick:le(p=>n.value=l.name,["prevent"]),title:`${l.count} 篇`},"# "+k(l.name),11,ki))),128))])):(o(),c("p",$i,"还没有标签，写第一篇文章时记得加上哦～")),a.value.length?(o(),c("h3",yi,[n.value?(o(),c(T,{key:0},[H("# "+k(n.value)+" ",1),d("span",Pi,"（"+k(a.value.length)+" 篇）",1)],64)):(o(),c(T,{key:1},[v[1]||(v[1]=H("全部内容 ",-1)),d("span",Li,"（"+k(a.value.length)+" 篇）",1)],64))])):m("",!0),d("div",Vi,[a.value.length?m("",!0):(o(),c("p",Si,"这个标签下还没有内容～")),(o(!0),c(T,null,w(a.value,l=>(o(),c("article",{key:l.url,class:"post-card"},[d("a",{href:l.url,class:"post-card-main"},[d("div",Ii,[l.date?(o(),c("span",Ai,[v[2]||(v[2]=d("span",{class:"post-date-icon"},"📅",-1)),H(k(l.date),1)])):m("",!0),(o(!0),c(T,null,w(l.tags,p=>(o(),c("span",{key:p,class:"post-tag"},"#"+k(p),1))),128))]),d("h4",Mi,k(l.title),1),l.description?(o(),c("p",wi,k(l.description),1)):m("",!0)],8,Ti),d("a",{href:l.url,class:"post-arrow","aria-label":"阅读文章"},"→",8,xi)]))),128))])]))}},Hi={class:"site-stats"},Ci={class:"stat-icon"},Bi={class:"stat-value"},Ei={class:"stat-label"},Di={__name:"SiteStats",setup(e){const t=Pe(),n=y(()=>{const s=t.filter(i=>!i.tags.includes("日记")).length,a=t.filter(i=>i.tags.includes("日记")).length,r=new Set(t.flatMap(i=>i.tags));return[{icon:"📝",label:"文章",value:s},{icon:"📔",label:"日记",value:a},{icon:"🏷️",label:"标签",value:r.size}]});return(s,a)=>(o(),c("div",Hi,[(o(!0),c(T,null,w(n.value,r=>(o(),c("div",{key:r.label,class:"stat-card"},[d("span",Ci,k(r.icon),1),d("span",Bi,k(r.value),1),d("span",Ei,k(r.label),1)]))),128))]))}},Fi={class:"about-page"},Oi={class:"about-hero"},Gi={class:"about-avatar-wrap"},ji=["src"],Ui={class:"about-actions"},zi=["href"],qi={__name:"AboutPage",setup(e){const t="/blog/";return(n,s)=>{const a=z("SiteStats");return o(),c("div",Fi,[d("div",Oi,[d("div",Gi,[d("img",{class:"about-avatar",src:u(t)+"tx.jpg",alt:"头像"},null,8,ji)]),s[3]||(s[3]=d("h1",{class:"about-name"},"成",-1)),s[4]||(s[4]=d("p",{class:"about-sign"},"「成的小屋」的主理人 · 写代码，也写生活",-1)),s[5]||(s[5]=d("p",{class:"about-bio"},"相信休息也是工作的一部分，喜欢把零碎的想法变成文字留下来。",-1)),s[6]||(s[6]=d("div",{class:"about-tags"},[d("span",null,"💻 前端"),d("span",null,"📝 VitePress"),d("span",null,"🔧 折腾爱好者"),d("span",null,"📒 记录控")],-1)),d("div",Ui,[s[1]||(s[1]=d("a",{class:"about-btn primary",href:"https://github.com/FC-Han",target:"_blank",rel:"noopener"},[d("span",{class:"btn-icon"},"🐙"),H(" GitHub ")],-1)),d("a",{class:"about-btn",href:u(t)+"diary"},[...s[0]||(s[0]=[d("span",{class:"btn-icon"},"📔",-1),H(" 我的日记 ",-1)])],8,zi),s[2]||(s[2]=d("a",{class:"about-btn",href:"mailto:you@example.com"},[d("span",{class:"btn-icon"},"✉️"),H(" 邮箱 ")],-1))])]),b(a),s[7]||(s[7]=Ye('<div class="about-grid"><div class="about-card"><h2 class="about-card-title">🙋 关于我</h2><p>你好，我是成。平时喜欢折腾各种小工具，把生活里零碎的想法写成文字留下来。这个博客就是我的一个小角落——技术笔记和生活碎片都在这里。</p></div><div class="about-card"><h2 class="about-card-title">🛠️ 这个站点</h2><ul class="about-list"><li>基于 <strong>VitePress</strong> 构建，原生支持 Markdown 与代码高亮。</li><li>部署在 <strong>GitHub Pages</strong>，源码与构建产物分离（main / gh-pages）。</li><li>文章、标签、日记一应俱全，写新内容只需丢一个 <code>.md</code> 文件。</li></ul></div><div class="about-card"><h2 class="about-card-title">🚀 最近在做</h2><ul class="about-list"><li>把博客打磨得更顺手，慢慢沉淀技术笔记。</li><li>坚持写日记，给生活留点痕迹。</li></ul></div><div class="about-card"><h2 class="about-card-title">☕ 一句话</h2><blockquote class="about-quote">慢下来，写下来。<br>休息也是工作的一部分。</blockquote></div></div>',1))])}}},Wi={key:0,class:"post-meta-head"},Ri={key:0,class:"pm-date"},Ki={class:"pm-tags"},Ji=["href"],Yi={__name:"PostMeta",setup(e){const{frontmatter:t}=ve(),n="/blog/";return(s,a)=>u(t).date||u(t).tags&&u(t).tags.length?(o(),c("div",Wi,[u(t).date?(o(),c("span",Ri,"🗓 "+k(u(t).date),1)):m("",!0),d("span",Ki,[(o(!0),c(T,null,w(u(t).tags||[],r=>(o(),c("a",{key:r,href:u(n)+"tags#"+r,class:"pm-tag"},"#"+k(r),9,Ji))),128))])])):m("",!0)}},Zi={__name:"Giscus",setup(e){const{isDark:t,frontmatter:n}=ve(),s=R(),a=I(null),r=y(()=>!!n.value&&!!n.value.date),i={repo:"FC-Han/blog",repoId:"R_kgDOT9Z9KA",category:"General",categoryId:"DIC_kwDOT9Z9KM4DD7h3",mapping:"pathname",strict:"0",reactionsEnabled:"1",emitMetadata:"0",inputPosition:"bottom",lang:"zh-CN",loading:"lazy"},v=()=>t.value?"dark":"light";function l(){if(!a.value)return;const _=a.value.querySelector("iframe.giscus-frame"),S=a.value.querySelector("script");_&&_.remove(),S&&S.remove()}function p(){if(!r.value||!a.value)return;l();const _=document.createElement("script");_.src="https://giscus.app/client.js",_.async=!0,_.crossOrigin="anonymous",_.setAttribute("data-repo",i.repo),_.setAttribute("data-repo-id",i.repoId),_.setAttribute("data-category",i.category),_.setAttribute("data-category-id",i.categoryId),_.setAttribute("data-mapping",i.mapping),_.setAttribute("data-strict",i.strict),_.setAttribute("data-reactions-enabled",i.reactionsEnabled),_.setAttribute("data-emit-metadata",i.emitMetadata),_.setAttribute("data-input-position",i.inputPosition),_.setAttribute("data-theme",v()),_.setAttribute("data-lang",i.lang),_.setAttribute("data-loading",i.loading),a.value.appendChild(_)}function L(){const _=a.value&&a.value.querySelector("iframe.giscus-frame");_&&_.contentWindow&&_.contentWindow.postMessage({giscus:{setConfig:{theme:v()}}},"https://giscus.app")}return O(()=>p()),E(()=>[s.path,r.value],()=>pe(p)),E(t,()=>L()),(_,S)=>r.value?(o(),c("div",{key:0,ref_key:"container",ref:a,class:"giscus-comments"},[...S[0]||(S[0]=[d("p",{class:"giscus-tip"},"💬 使用 GitHub 账号即可在下方留言",-1)])],512)):m("",!0)}},Se=P(Zi,[["__scopeId","data-v-b78e9755"]]),Xi={extends:Ve,enhanceApp({app:e}){e.component("PostList",_i),e.component("TagList",Ni),e.component("SiteStats",Di),e.component("AboutPage",qi),e.component("Giscus",Se)},Layout(e){return ae(Ve.Layout,e,{"doc-before":()=>ae(Yi),"doc-after":()=>ae(Se)})}};export{Xi as R};
